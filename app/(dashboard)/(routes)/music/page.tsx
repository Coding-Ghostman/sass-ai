...
export default function MusicPage() {
    ...
    return (
        <div>
            <Heading title="Music Generation" description="Turn your prompt to music" icon={Music} iconColor="text-emerald-500" bgColor="bg-emerald-500/10" />
